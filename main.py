...
# memuat model nlp dan vektorizer tfidf dari disk
filename = 'nlp_model.pkl'
clf = pickle.load(open(filename, 'rb'))
vectorizer = pickle.load(open('tranform.pkl','rb'))
    
# mengonversi daftar string ke daftar (mis. "["abc","def"]" menjadi ["abc","def"])
...
# mengonversi daftar angka menjadi daftar (mis. "[1,2,3]" menjadi [1,2,3])
...
def recommend():
    ...
    # mendapatkan rekomendasi film untuk auto complete
    suggestions = get_suggestions()

    # memanggil fungsi convert_to_list untuk setiap string yang perlu dikonversi ke daftar
    ...
    # menggabungkan beberapa daftar sebagai dictionary yang dapat diteruskan ke file html sehingga dapat diproses dengan mudah dan urutan informasi akan dipertahankan
    ...
    # web scraping untuk mendapatkan ulasan pengguna dari situs IMDB
    ...
    # menggabungkan ulasan dan komentar ke dalam dictionary
    movie_reviews = {reviews_list[i]: reviews_status[i] for i in range(len(reviews_list))}     

    # meneruskan semua data ke file html
